...
class GetParkOperInfoUsecase @Inject constructor(private val repository: ParkRepository) {
    /**
     ...
     */
    operator fun invoke(): Flowable<List<ParkOperInfo>> = repository.getRemoteParkOperInfo();
}